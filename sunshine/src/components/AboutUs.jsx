      ...
      <div className="bg-[#F4F4F7] pt-5  w-full h-full">
        <div className="flex flex-col items-center justify-center w-full text-center ">
          ...
          <div className="text-[#7a7a7a] mt-6 text-[17px] text-justify   mx-6 lg:mx-16 md:mx-16 leading-relaxed font-[400]">
            Welcome to <span className="px-1 text-red-400 "> Sunshine Budokan Karate Dojos </span> ! We are proud to be the
          ...
          <div className="text-[#7a7a7a] mt-6 text-[17px]  text-justify  mx-6 lg:mx-16 md:mx-16 leading-relaxed font-[400]">
            ...
            beginner taking your first steps on the martial arts journey or an
            advanced practitioner honing your skills, our dojo is the perfect
          ...
          <div className="text-[#7a7a7a]  text-[17px] my-6 pb-6  text-justify  mx-6 lg:mx-16 md:mx-16 leading-relaxed font-[400]">
            ...
            karate, bring their extensive expertise to our dojo, ensuring
            top-notch instruction. We take immense pride in upholding the
            esteemed heritage of this martial discipline, passing on its
            time-honored traditions to our students with unwavering dedication
            and enthusiasm.
          </div>
        </div>
      </div>
